...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i6="http://iuclid6.echa.europa.eu/namespaces/platform-fields/v1" xmlns:i6c="http://iuclid6.echa.europa.eu/namespaces/platform-container/v1" xmlns:xt="http://iuclid6.echa.europa.eu/namespaces/ENDPOINT_STUDY_RECORD-RepeatedDoseToxicityInhalation/7.0" version="1.0">
    <xsl:template match="/">
        <html>
            <head>
    ...
    <xsl:template match="//xt:ENDPOINT_STUDY_RECORD">
        <tr class="headerDocument">
            <td>Repeated dose toxicity: inhalation</td>
            <td>
                <hr/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td class="value">
                ...
                <xsl:choose>
                    ...
                    <xsl:when test="./unitCode = '116620'"> CFU/L air (nominal)</xsl:when>
                    <xsl:when test="./unitCode = '116621'"> CFU/L air (analytical)</xsl:when>
                    <xsl:when test="./unitCode = '116607'"> CFU/m³ air</xsl:when>
                    <xsl:when test="./unitCode = '116608'"> CFU/m³ air (nominal)</xsl:when>
                    <xsl:when test="./unitCode = '116609'"> CFU/m³ air (analytical)</xsl:when>
                    <xsl:when test="./unitCode = '116664'"> CFU/kg bw/day</xsl:when>
                    <xsl:when test="./unitCode = '116625'"> IU/L air</xsl:when>
                    <xsl:when test="./unitCode = '116626'"> IU/L air (nominal)</xsl:when>
                    <xsl:when test="./unitCode = '116627'"> IU/L air (analytical)</xsl:when>
                    <xsl:when test="./unitCode = '116613'"> IU/m³ air</xsl:when>
                    <xsl:when test="./unitCode = '116614'"> IU/m³ air (nominal)</xsl:when>
                    <xsl:when test="./unitCode = '116615'"> IU/m³ air (analytical)</xsl:when>
                    <xsl:when test="./unitCode = '116666'"> IU/kg bw/day</xsl:when>
                    <xsl:when test="./unitCode = '116622'"> OB/L air</xsl:when>
                    <xsl:when test="./unitCode = '116623'"> OB/L air (nominal)</xsl:when>
                    <xsl:when test="./unitCode = '116624'"> OB/L air (analytical)</xsl:when>
                    <xsl:when test="./unitCode = '116610'"> OB/m³ air</xsl:when>
                    <xsl:when test="./unitCode = '116611'"> OB/m³ air (nominal)</xsl:when>
                    <xsl:when test="./unitCode = '116612'"> OB/m³ air (analytical)</xsl:when>
                    <xsl:when test="./unitCode = '116662'"> OB/kg bw/day</xsl:when>
                    <xsl:when test="./unitCode = '129822'"> spores/L air</xsl:when>
                    <xsl:when test="./unitCode = '129824'"> spores/L air (nominal)</xsl:when>
                    <xsl:when test="./unitCode = '129825'"> spores/L air (analytical)</xsl:when>
                    <xsl:when test="./unitCode = '116616'"> spores/m³ air</xsl:when>
                    <xsl:when test="./unitCode = '116606'"> spores/m³ air (nominal)</xsl:when>
                    <xsl:when test="./unitCode = '116618'"> spores/m³ air (analytical)</xsl:when>
    ...
    <xsl:template match="//xt:MassMedianAerodynamicDiameter | //xt:EffectLevel">
        <tr>
            <td class="label">
                <xsl:choose>
            ...
            <td class="value">
                ...
                <xsl:choose>
                    ...
                    <xsl:when test="./i6:unitCode = '116666'"> IU/kg bw/day</xsl:when>
                    ...
                    <xsl:when test="./i6:unitCode = '129824'"> spores/L air (nominal)</xsl:when>
                    <xsl:when test="./i6:unitCode = '129825'"> spores/L air (analytical)</xsl:when>
        ...
        <tr>
            ...
            <td class="value">
                <xsl:choose>
                    ...
                    <xsl:when test="./i6:value = '61215'">a short-term toxicity study does not need to be conducted because exposure of humans via inhalation in production and/or use is not likely as based on the provided thorough and rigorous exposure assessment</xsl:when>
                    ...
                    <xsl:when test="./i6:value = '61898'">A sub-chronic toxicity study (90 days) does not need to be conducted because the substance is unreactive, insoluble and not inhalable and there is no evidence of absorption and no evidence of toxicity in a 28-day 'limit test' and human exposure is limited</xsl:when>
    ...
    <xsl:template match="//xt:Endpoint | //xt:StudyResultType | //xt:PurposeFlag | //xt:Reliability | //xt:RationalReliability | //xt:DataWaiving | //xt:ReasonPurpose | //xt:ReasonPurpose | //xt:DataAccess | //xt:DataProtectionClaimed | //xt:Qualifier | //xt:Guideline | //xt:Deviation | //xt:GLPComplianceStatement | //xt:LimitTest | //xt:Species | //xt:Strain | //xt:Sex | //xt:RouteOfAdministration | //xt:TypeOfInhalationExposure | //xt:Vehicle | //xt:AnalyticalVerificationOfDosesOrConcentrations | //xt:ObservClinSigns | //xt:ObservMortality | //xt:ObservBodyweight | //xt:ObservFoodConsum | //xt:ObservFoodEfficiency | //xt:ObservWaterConsum | //xt:ObservOphthalm | //xt:ObservHaematol | //xt:ObservClinChem | //xt:EndocrineFindings | //xt:ObservUrin | //xt:ObservNeurobehaviour | //xt:ImmunologicalFindings | //xt:ObservOrganWeights | //xt:ObservGrpathol | //xt:ObservNeuropathol | //xt:ObservHistopathol | //xt:ObservHistopatholNeoplastic | //xt:OtherEffects | //xt:Endpoint | //xt:BasedOn | //xt:Sex | //xt:RemarksOnResults | //xt:CriticalEffectsObserved | //xt:System | //xt:TreatmentRelated | //xt:DoseResponseRelationship | //xt:RelevantForHumans | //xt:Type">
        <tr>
            ...
            <td class="value">
                <xsl:choose>
                    <xsl:when test="./i6:value = '61200'">short-term repeated dose toxicity: inhalation</xsl:when>
                    <xsl:when test="./i6:value = '61201'">sub-chronic toxicity: inhalation</xsl:when>
                    <xsl:when test="./i6:value = '61202'">chronic toxicity: inhalation</xsl:when>
                    <xsl:when test="./i6:value = '61203'">repeated dose toxicity: inhalation, other</xsl:when>
                    <xsl:when test="./i6:value = '61967'">repeated dose toxicity: inhalation</xsl:when>
                    ...
                    <xsl:when test="./i6:value = '65622'">OECD Guideline 412 (28-Day (Subacute) Inhalation Toxicity Study</xsl:when>
                    <xsl:when test="./i6:value = '1260'">OECD Guideline 412 (Subacute Inhalation Toxicity: 28-Day Study)</xsl:when>
                    <xsl:when test="./i6:value = '65623'">OECD Guideline 413 (90-Day (Subchronic) Inhalation Toxicity Study</xsl:when>
                    <xsl:when test="./i6:value = '1261'">OECD Guideline 413 (Subchronic Inhalation Toxicity: 90-Day Study)</xsl:when>
                    ...
                    <xsl:when test="./i6:value = '704'">EU Method B.8 (Subacute Inhalation Toxicity: 28-Day Study)</xsl:when>
                    <xsl:when test="./i6:value = '685'">EU Method B.29 (Sub-Chronic Inhalation Toxicity:90-Day Study)</xsl:when>
                    ...
                    <xsl:when test="./i6:value = '415'">EPA OPP 82-4 (90-Day Inhalation Toxicity)</xsl:when>
                    <xsl:when test="./i6:value = '418'">EPA OPP 83-1 (Chronic Toxicity)</xsl:when>
                    <xsl:when test="./i6:value = '511'">EPA OPPTS 870.3465 (90-Day Inhalation Toxicity)</xsl:when>
                    ...
                    <xsl:when test="./i6:value = '602'">EPA OTS 798.2450 (90-Day Inhalation Toxicity)</xsl:when>
