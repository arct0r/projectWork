...
with cir_tab:
    ...
    if substance:
        ...
        qq = f'Leggi questo testo e trova i valori di NOAEL e di LD50 presenti soltanto per la sostanza {substance}, poi creami una tabella coi valori trovati. Se non esiste il valore per la sostanza, restituisci "VALORI NON TROVATI"\n'
